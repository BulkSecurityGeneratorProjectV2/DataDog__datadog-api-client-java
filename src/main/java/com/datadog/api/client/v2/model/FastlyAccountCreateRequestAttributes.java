...
public class FastlyAccountCreateRequestAttributes {
  ...
  public FastlyAccountCreateRequestAttributes services(
      List<FastlyServiceRequestAttributes> services) {
  ...
  public FastlyAccountCreateRequestAttributes addServicesItem(
