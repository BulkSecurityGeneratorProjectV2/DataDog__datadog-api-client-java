...
@JsonPropertyOrder({
  ...
  FastlyAccountCreateRequestData.JSON_PROPERTY_ID,
...
public class FastlyAccountCreateRequestData {
  ...
  public FastlyAccountCreateRequestData(
      @JsonProperty(required = true, value = JSON_PROPERTY_ATTRIBUTES)
          FastlyAccountCreateRequestAttributes attributes,
  ...
  public FastlyAccountCreateRequestData attributes(
      FastlyAccountCreateRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  ...
  public FastlyAccountCreateRequestData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FastlyAccountCreateRequestData fastlyAccountCreateRequestData =
        (FastlyAccountCreateRequestData) o;
    return Objects.equals(this.attributes, fastlyAccountCreateRequestData.attributes)
        && Objects.equals(this.id, fastlyAccountCreateRequestData.id)
        && Objects.equals(this.type, fastlyAccountCreateRequestData.type);
  }
